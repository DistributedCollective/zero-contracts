...
contract('StabilityPool', async accounts => {
  ...
  describe("Stability Pool Mechanisms", async () => {
    ...
    it("provideToSpFromDLLR(): decrease DLLR amount and updates the user's record in StabilityPool", async () => {
      ...
      const permission = await signERC2612Permit(alice_signer, nueMockToken.address, alice_signer.address, nueMockTokenTransferWithPermit.address, spAmount.toString());
